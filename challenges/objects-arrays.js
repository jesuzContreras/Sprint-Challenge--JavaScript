...
zooAnimals.map(function(name){
  return lowCaseAnimalNames.push(name.animal_name.toLowerCase());
})
...
lowPopulationAnimals = zooAnimals.filter(function(value){
...
populationTotal = zooAnimals.reduce (function(acc, value) {
